...
public class MainFrame extends JFrame {
	...
	public void showName(int playerid,List<Player> players)
	{
		//根据玩家id显示到具体的位置
			JLabel playerID1=new JLabel();
			 playerID1.setBounds(50, 350,250,50);
			 playerID1.setText(players.get(playerid).getName());
			 playerID1.setFont(new Font("Dialog", 0, 40));
			 playerID1.setForeground(Color.red);
			
			 this.myPanel.add(playerID1);
			 
			 JLabel playerID2=new JLabel();
			 playerID2.setBounds(120, 120,250,50);
			 playerID2.setText(players.get((playerid+3-1)%3).getName());
			 playerID2.setFont(new Font("Dialog", 0, 40));
			 playerID2.setForeground(Color.red);
			 this.myPanel.add(playerID2);
			 
			 //下家
			 JLabel playerID3=new JLabel();
			 playerID3.setBounds(1000, 100,250,50);
			 playerID3.setText(players.get((playerid+1)%3).getName());
			 playerID3.setFont(new Font("Dialog", 0, 40));
			 playerID3.setForeground(Color.red);
			 this.myPanel.add(playerID3);
