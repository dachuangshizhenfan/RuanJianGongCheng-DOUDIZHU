					  ...
					  if(typeid==1) 
						{
							...
							else if(playerid+1==mainFrame.currentPlayer.getId())	 //3.设置下一家开始抢地主						
								mainFrame.getLord();
						  ...
						  if(playerid==mainFrame.currentPlayer.getId())
						   {
							   ...
							   if(contentString.equals("农民胜利") && !mainFrame.isLord) 
								   JOptionPane.showMessageDialog(mainFrame, "赢了");
							   
							   else JOptionPane.showMessageDialog(mainFrame, "输了");
